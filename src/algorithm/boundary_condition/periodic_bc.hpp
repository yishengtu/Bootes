...
void periodic_boundary_condition_x1i(BootesArray<float> &quan, int &x1s, int &x1l, int &ng1,
...
void periodic_boundary_condition_x1o(BootesArray<float> &quan, int &x1s, int &x1l, int &ng1,
                                                              int &x2s, int &x2l, int &ng2,
                                                              int &x3s, int &x3l, int &ng3){
    #pragma omp parallel for collapse(4)
    for (int valIND = 0; valIND < quan.shape()[0]; valIND ++){
...
void periodic_boundary_condition_x2i(BootesArray<float> &quan, int &x1s, int &x1l, int &ng1,
                                                              int &x2s, int &x2l, int &ng2,
                                                              int &x3s, int &x3l, int &ng3){
    #pragma omp parallel for collapse(4)
    for (int valIND = 0; valIND < quan.shape()[0]; valIND ++){
...
void periodic_boundary_condition_x2o(BootesArray<float> &quan, int &x1s, int &x1l, int &ng1,
                                                              int &x2s, int &x2l, int &ng2,
                                                              int &x3s, int &x3l, int &ng3){
    #pragma omp parallel for collapse(4)
    for (int valIND = 0; valIND < quan.shape()[0]; valIND ++){
...
void periodic_boundary_condition_x3i(BootesArray<float> &quan, int &x1s, int &x1l, int &ng1,
                                                              int &x2s, int &x2l, int &ng2,
                                                              int &x3s, int &x3l, int &ng3){
    #pragma omp parallel for collapse(4)
    for (int valIND = 0; valIND < quan.shape()[0]; valIND ++){
...
void periodic_boundary_condition_x3o(BootesArray<float> &quan, int &x1s, int &x1l, int &ng1,
                                                              int &x2s, int &x2l, int &ng2,
                                                              int &x3s, int &x3l, int &ng3){
    #pragma omp parallel for collapse(4)
    for (int valIND = 0; valIND < quan.shape()[0]; valIND ++){
